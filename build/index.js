...
module.exports.addModules({
  ...
  EmptyOptionalNode: __webpack_require__(24),
  Node: __webpack_require__(12),
  ScratchNode: __webpack_require__(25)
});
...
defineModule(module, Repl = (function() {
  ...
  Repl.caffeineEightRepl = function(parser) {
    ...
    return __webpack_require__(29).start({
...
module.exports = (__webpack_require__(28)).addNamespace('Caffeine.Eight', Eight = (function(superClass) {
  ...
  Eight.version = __webpack_require__(18).version;
...
module.exports.includeInNamespace(__webpack_require__(21)).addModules({
...
module.exports.addModules({
  IndentBlocks: __webpack_require__(22)
});
...
module.exports = require('color' /* ABC - not inlining fellow NPM */);
